      ...
      {isDashboard || isSignIn ? (
        ...
        <footer className='mt-20 mb-10 w-11/12 mx-auto text-[#304428] md:flex md:flex-row'>
          <Image
            ...
            width={400}
            height={400}
            className='rounded-xl md:w-1/2 md:mr-10'
          />
          ...
          <div className='md:w-1/2 md:h-full'>
            <div className='bg-[#eae0d4] text-[#304428] py-10 px-5 my-5 rounded-xl md:mt-0'>
              ...
              <ul className='font-quicksand'>
                <li className='flex items-center my-1'>
                  <MapPinIcon className='w-4 h-4 mr-2' /> Jl. Williem Iskandar
                  No. 73, Medan
                </li>
                <li className='flex items-center my-1'>
                ...
                <li className='flex items-center my-1'>
                  <ClockIcon className='w-4 h-4 mr-2' /> Open Mon-Sun | 8 AM -
                  10 PM
                </li>
              </ul>
            </div>
            ...
            <div className='flex items-center bg-[#eae0d4] px-5 py-5 rounded-xl'>
              ...
              <div className='w-10/12 text-right font-quicksand'>
