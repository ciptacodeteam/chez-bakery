        ...
        <>
            {
                ...
                <header className="absolute inset-x-0 top-5 z-50 bg-black/70 w-11/12 mx-auto rounded-full">
                    ...
                    <Dialog open={mobileMenuOpen} onClose={setMobileMenuOpen} className="lg:hidden">
                        ...
                        <DialogPanel className="fixed inset-y-0 right-0 z-50 w-full overflow-y-auto bg-black p-6 sm:max-w-sm sm:ring-1 sm:ring-gray-900/10" style={{ fontFamily: "var(--font-quicksand)" }}>
