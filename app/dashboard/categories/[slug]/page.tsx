        ...
        <div className='mt-6 border-t border-gray-100'>
          <form onSubmit={handleSubmit}>
            <dl className='divide-y divide-gray-100'>
              <div className='px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0 font-quicksand'>
                ...
                <dd className='mt-1 text-sm/6 text-gray-700 sm:col-span-2 sm:mt-0'>
                  {isLoading ? (
                    ...
                    <input
                      ...
                      className={clsx(
                        'block w-full rounded-md bg-white px-3 py-1.5 text-base text-gray-900 border placeholder:text-gray-400 focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600 sm:text-sm/6',
                  ...
                  {isLoading ? (
                    ...
                    <div>
                      ...
                      <input
                        ...
                        className={clsx(
                          'block w-full rounded-md bg-white px-3 py-1.5 text-base text-gray-900 border placeholder:text-gray-400 focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600 sm:text-sm/6 mt-4',
                          errors.categoryImage === undefined
                            ? 'border-gray-300'
                            : 'border-red-500'
                        )}
                      />
